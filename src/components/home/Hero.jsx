...
// import { ArrowRight, ChevronDown, Droplets, Factory, Sparkles, Zap } from 'lucide-react';
...
//   { word: 'Electrical', icon: Zap, color: 'text-amber-300' },
//   { word: 'Plumbing', icon: Droplets, color: 'text-cyan-300' },
//   { word: 'Housekeeping', icon: Sparkles, color: 'text-emerald-300' },
//   { word: 'STP Plants', icon: Factory, color: 'text-slate-300' },
// ];

// const bgSlides = [
//   { image: construction, label: 'Facility Management' },
//   { image: electrician, label: 'Electrical Works' },
//   { image: plumbing, label: 'Plumbing Systems' },
//   { image: housekeeping, label: 'Housekeeping Services' },
//   { image: stp, label: 'STP Operations' },
// ];

// const servicePills = [
//   { icon: Zap, label: 'Electrician', color: 'bg-amber-500/20 text-amber-200 border-amber-400/30' },
//   { icon: Droplets, label: 'Plumbing', color: 'bg-cyan-500/20 text-cyan-200 border-cyan-400/30' },
//   { icon: Sparkles, label: 'Housekeeping', color: 'bg-emerald-500/20 text-emerald-200 border-emerald-400/30' },
//   { icon: Factory, label: 'STP Plants', color: 'bg-slate-500/20 text-slate-200 border-slate-400/30' },
// ];
...
//   const parallaxY = useTransform(scrollYProgress, [0, 1], ['0%', prefersReducedMotion ? '0%' : '20%']);
...
//     >
//       {/* Background — opacity crossfade (no mount/unmount stutter) */}
...
//             >
//               <span className="text-shimmer block">Reliable Facility</span>
...
//             >
//               Comprehensive electrician, plumbing, housekeeping, and STP plant services for
//               residential, commercial, and industrial properties across India.
//             </motion.p>
...
//                     transition={{ delay: 0.5 + i * 0.06, duration: 0.4, ease: EASE }}
...
//                       i === slideIndex ? 'w-8 bg-brand-400' : 'w-3 bg-white/30 hover:bg-white/50'
//                     }`}
//                   />
//                 ))}
//               </motion.div>
...
//         {!prefersReducedMotion && (
//           <motion.div variants={fadeInUp} className="lg:hidden mt-10 overflow-hidden">
//             <motion.div
